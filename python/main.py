...
from SERPScrap import app as SERP
from unique_content2 import app as unique_content2
...
from internal_linking import app as internalLinks
from fastapi.middleware.cors import CORSMiddleware
from fastapi.middleware.httpsredirect import HTTPSRedirectMiddleware
from fastapi.staticfiles import StaticFiles
from ApiV2.route import app as v2
import os
import uvicorn
...
main_app.mount("/v2", v2)
main_app.mount("/get-ranking", SERP)
main_app.mount("/similar_content", similar_content)
main_app.mount("/internal_linking/bot1", internalLinks)
# main_app.mount("/delete_file", delete_file)
main_app.mount("/unique_content", unique_content)
main_app.mount("/unique_content2", unique_content2)
